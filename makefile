...
all: ParallelMergeSort.class ParallelQuickSort.class Sorting.class graphing.class
...
test_classes: all ParallelMergeSort.class ParallelQuickSort.class graphing.class Sorting.class
